...
android {
    namespace = "com.raindropstudio.jatayat"
    ...
    defaultConfig {
        applicationId = "com.raindropstudio.jatayat"
    ...
    buildTypes {
        getByName("debug") {
            // No signingConfig needed here!
            // It automatically uses the local debug.keystore.
